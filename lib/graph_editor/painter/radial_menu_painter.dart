...
class RadialMenuPainter {
  Paint getIconPaint(RadialMenuItem item) {
    if (item.disabled) return Graph.RadialMenuDisabledIconColor;
  ...
  void paint(Canvas canvas, RadialMenuState menu) {
    ...
    for (var sector in menu.sectors) {
      ...
      VectorIcons.paint(
        ...
        sector.icon,
        pos,
        sector.hovered && !sector.disabled ? iconSize * 1.25 : iconSize,
        fill: getIconPaint(sector),
      );
    }
